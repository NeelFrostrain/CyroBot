...
export default class Avatar extends Command {
    data = new SlashCommandBuilder()
        ...
        .setRequired(false)
        .addChoices({ name: "16", value: "16" }, { name: "32", value: "32" }, { name: "64", value: "64" }, { name: "128", value: "128" }, { name: "256", value: "256" }, { name: "512", value: "512" }, { name: "1024", value: "1024" }, { name: "2048", value: "2048" }, { name: "4096", value: "4096" }));
    async execute(interaction, client) {
        try {
            const user = interaction.options.getUser("user", false) || interaction.user;
            const size = parseInt(interaction.options.getString("size", false) || "1024");
